...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="erakundea">
        ...
        944 02 80 00 <br />
                ...
                <!--<script>
                // Filtroa aplikatzeko funtzioa function ArkeztuLangileak() { var
        departamentua = document.getElementById("departamentua").value; var rol =
        document.getElementById("rolak").value; window.location.href = "
                    <?php echo $_SERVER['PHP_SELF'];?>?departamentua=" +
        departamentua + "&rolak=" + rol; } </script>-->
            </body>
